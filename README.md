...
- **DN.ERA5_TC_TEST.csh**: detecting potential TC candidate points using TempestExtremes (must be local minima in sea level pressure and have a warm core)
- **SN.ERA5_TC_TEST.csh**: stitching together individual storms using TempestExtremes (storms must last at least 54 hours, have maximum wind speeds exceeding 10 m/s for at least 10 time slices, and lie between 50S-50N for at least 10 time slices)
